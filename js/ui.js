...
export * from './modules/ui-toast.js';
export * from './modules/ui-calendar.js';
export * from './modules/ui-ocr.js';
export * from './modules/ui-split.js';
...
export function renderTrendChart() {
  ...
  ctx.font = (compact ? '600 9px ' : '600 10px ') + '"Plus Jakarta Sans", sans-serif';
  ctx.textAlign = 'right';
  for (let j = 0; j <= 4; j++) {
